...
namespace DevConnectMoura.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        {
            TempData["UsuarioNovoCadstrado"] = "Cadastrado";
            ViewBag.UsuarioNovoCadstrado = "";
            return View();
        }
        ...
        public async Task<IActionResult> Index(IFormCollection form)
        {
            ...
            if (form.Files.Count > 0 )
            {
                ...
                novoUsuario.FotoPerfilUsuario = file.FileName;
            }
            else
            {
                novoUsuario.FotoPerfilUsuario = "";
            }
            ...
            {
                ViewBag.UsuarioNovoCadstrado = "Nao Cadastrado";
                 TempData["UsuarioNovoCadstrado"] = "";
               return View();  
